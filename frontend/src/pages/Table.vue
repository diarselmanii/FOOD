    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('383')) {
            ...
            if (this.orderObj.card) {
                if (!/[0-9]{5}/.test(this.orderObj.card)) {
                        this.errorObj.cardErr.push('Card numbers can only contain numbers');
                    }

                if (this.orderObj.card.length != 5) {
                    this.errorObj.cardErr.push('Card number must have exactly 5 digits');
                }
            }
